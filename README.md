# Python-Vehicle-Dynamics-Analyses
This code is made by taking accelerometer and gyroscope infos formated as .csv and showing them as graphs and diagrams with the aim of getting a better understanding of the vehicle dynamics. It was made for Formula SAE porpouses.

1. Python-docx library download is needed.
2. The .csv files in the repository are not real, they are here for exemplifying how the code works.
